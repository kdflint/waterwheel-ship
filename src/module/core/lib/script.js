...
function switchToAbout() {
	var contextSwitcher = document.getElementById("contextSwitch");
	...
	document.getElementById("curtain").style.width = "0px";
 	contextSwitcher.innerHTML='<span class="fa fa-chevron-circle-left fa-2x tan" style="margin-right:10px;vertical-align:middle;"></span>Grants/Benefits';
	contextSwitcher.onclick = function() {switchToSponsor()}
 	switchAboutView(1);
...
function switchToSponsor() {
	...
	contextSwitcher.innerHTML='About Northbridge<span class="fa fa-chevron-circle-right fa-2x tan" style="margin-left:10px;vertical-align:middle;vertical-align:middle;">';
	contextSwitcher.onclick = function() {switchToAbout()}
	hideInfoEmailField();
