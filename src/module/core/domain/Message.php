...
class Message {
	...
	private function getSalutation($typeId) {
		switch ($typeId) {
      case self::PARTNER_INFORMATION_PACKET;
      	return "Congratulations on discovering Northbridge Technology Alliance!";
    	default:
