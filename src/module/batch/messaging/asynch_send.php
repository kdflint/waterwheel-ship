...
// Soft link to web app domain
require_once("../domain/Util.php");

// while there are pending messages
// 	call message database for 20 pending
// 	should include To address and salutation name
// 	for each message type
//			instantiate the message object - where should this live?
//			update status
