<?php define("SPONSOR_ROOT", "http://localhost/waterwheel/module/core"); ?>
					...
					<div class="mod-sponsor-contentLeft">
						<form id="sponsorForm" class="pure-form" style="padding:7px;">							
							...
							<div class="mod-sponsor-controlDesignate">
								...
								<div class="mod-sponsor-controlContent">							
	        						...
	        						<div class="slide" id="slide1"><img src="<?php echo SPONSOR_ROOT; ?>/images/cat.gif" height="" width="200" style="margin:2px;"/></div>
        							<div class="slide" id="slide2"><img src="<?php echo SPONSOR_ROOT; ?>/images/ec.gif" height="" width="" style="margin:2px;"/></div>
       								<div class="slide" id="slide3"><img src="<?php echo SPONSOR_ROOT; ?>/images/cfcht.png" height="" width="200" style="margin:2px;"/></div>
